...
function CardStats() {
  ...
  const chartData = [
    {
      name: "Card 1",
      data: [2199, 652, 500, 1032, 2400, 191, 249, 582, 2500, 872, 120, 500]
    },
    {
      name: "Card 2",
      data: [191, 1032, 500, 872, 2400, 2500, 652, 582, 120, 500, 249, 2199]
    },
    {
      name: "Card 3",
      data: [199, 500, 2500, 872, 120, 191, 1032, 582, 652, 2400, 249, 500]
    }
  ];
